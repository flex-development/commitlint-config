...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/commitlint-config
...
```sh
https://github.com/flex-development/commitlint-config/compare/main...$branch
```
...
[19]: https://github.com/flex-development/commitlint-config/discussions/new?category=q-a
